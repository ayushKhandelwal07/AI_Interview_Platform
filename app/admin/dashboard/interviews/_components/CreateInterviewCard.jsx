...
function CreateInterviewCard({ onClick }) {
  return (
    <div 
      className='p-10 bg-gradient-to-br from-blue-50 to-indigo-100 border-2 border-dashed border-blue-300 rounded-2xl hover:scale-105 cursor-pointer transition-all hover:shadow-lg group'
      onClick={onClick}
    >
